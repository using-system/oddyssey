...
| 2026-09-16 | 2026-09-16-2012-verify-mcp-read-tools.md / F11 | wontfix | Measured in situ on 2026-09-16: a --format template changes nothing (34.7 vs 35.4 ms p50 for the two-object inspect; 19.7 ms for the container alone) - the cost is per object, and the image read is the price of the #83 correctness rule; an env cache keyed by image digest is a design decision left to the maintainer |
