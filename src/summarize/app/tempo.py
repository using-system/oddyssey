...
# exposed, and the same path works against any Grafana that has a "tempo"
# datasource (the otel-lgtm image provisions that UID).
DEFAULT_BASE_URL = "http://localhost:3000/api/datasources/proxy/uid/tempo"
