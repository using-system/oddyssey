...
```bash
uvx --from 'apm-cli==0.29.1' apm install --global --target claude using-system/oddyssey
```
...
```bash
uvx --from 'apm-cli==0.29.1' apm update --global --target claude using-system/oddyssey
```
