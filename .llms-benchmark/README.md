...
| --- | --- | --- | --- | --- | --- | --- | --- |
| **#1** | `z-ai/glm-5.3` | 1.11.4 | **16 / 16** | 10 / 4 / 2 | 38m22s | $4.02 | $0.251 |
| **#2** | `google/gemini-3.8-flash` | 1.11.4 | **8 / 8** | 4 / 3 / 1 | 15m29s | $1.66 | $0.207 |
| **#3** | `z-ai/glm-5.3-flash` | 1.11.4 | 11 / 12 | 6 / 4 / 1 | 48m39s | **$0.16** | **$0.015** |
| **#4** | `qwen/qwen3.8-max-0902` | 1.11.4 | 13 / 14 | 9 / 3 / 1 | 59m53s | $2.74 | $0.211 |
| **#5** | `google/gemini-3.7-flash` | 1.11.4 | 5 / 6 | 3 / 2 / 0 | **10m51s** | $1.07 | $0.213 |
